...
print "    def __init__(self, font=None, guidelineClass=None):"
print "        if font is not None:"
print "            font = weakref.ref(font)"
print "        self._font = font"
print "        super(Info, self).__init__()"
print "        self.beginSelfNotificationObservation()"
...
print "        super(Info, self).__del__()"
print "        self._guidelines = None"
print

print "    def getParent(self):"
print "        return self.font"
print

print
print "    def _get_font(self):"
print "        if self._font is not None:"
print "            return self._font()"
print "        return None"
print
