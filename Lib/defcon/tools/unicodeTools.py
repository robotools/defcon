...
11C38..11C3B  ; Bhaiksuki # Mc   [4] BHAIKSUKI VOWEL SIGN E..BHAIKSUKI VOWEL SIGN AU
11C3C..11C3D  ; Bhaiksuki # Mn   [2] BHAIKSUKI SIGN CANDRABINDU..BHAIKSUKI SIGN ANUSVARA
...
def _searchRanges(value, available):
    ...
    if value < minValue:
        return _searchRanges(value, lessRange)
    elif value > maxValue:
